...
export function ShopByShape() {
  return (
    <section className="py-16 bg-cream-50 border-y border-neutral-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-4xl font-serif text-neutral-900 mb-8">Encontre o formato certo</h2>
